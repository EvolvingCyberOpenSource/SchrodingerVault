...
// ============================================================
// For frontend design testing only to make switch between "index", "unlock", "create" easy

const DESIGN_PAGE = "create";

window.addEventListener("DOMContentLoaded", async() => {
    // Skip backend initialization & redirect logic entirely.
    console.log(`[Design Mode] Loading static page: ${DESIGN_PAGE}`);
    ...
    switch (DESIGN_PAGE) {
        ...
        case "unlock":
            window.location.href = "unlock.html?design=1";
            break;

        case "create":
            window.location.href = "create.html?design=1";
            break;

        default:
            console.warn("Unknown DESIGN_PAGE value:", DESIGN_PAGE);
    }
});
